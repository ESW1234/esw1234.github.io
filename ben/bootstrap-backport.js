...
(() => {
	...
	const SALESFORCE_DOMAINS = [
		...
		// Used by local environments and Akamai CDN
		".site.com",
	...
	******************************************************/
	...
	function createConversationButton() {
		...
		buttonElement.style.background = getFABColorToUpdateAfterAppLoad();
