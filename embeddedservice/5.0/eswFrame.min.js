...
domain:a}),setTimeout(function(){k||(this.sessionLoaded=!0,delete d[b.deploymentId],esw.sessionAPI.setSessionData(a,{ACTIVE_CHAT_SESSIONS:JSON.stringify(d)},!0),parent.postMessage({method:"session.onLoad"},this.parentOrigin))}.bind(this),500)):parent.postMessage({method:"session.onLoad"},this.parentOrigin)}.bind(this)),parent.postMessage({method:"session.frameReady"},this.parentOrigin)):console.error("No domain set!")}var n=["broadcast","chasitor","filetransfer","session"];e.prototype.isInternetExplorer=
function(){return"ActiveXObject"in window};e.prototype.isEdge=function(){return window.navigator&&window.navigator.userAgent&&"string"===typeof window.navigator.userAgent?-1<window.navigator.userAgent.indexOf("Edge"):!1};e.prototype.log=function(a,b){(window.devMode||b)&&console.log(a)};e.prototype.getSafariType=function(){var a=navigator.userAgent.toLowerCase(),b=!window.safari,c="ontouchend"in document;return-1===a.indexOf("chrome")&&-1!==a.indexOf("safari")?b&&c?"mobile":"desktop":"none"};e.prototype.addMessageHandler=
function(a,b){this.messageHandlers[a]=b};e.prototype.addEventListeners=function(){window.addEventListener("message",function(a){var b=a.data;if(b&&b.method){var c=a.origin.indexOf("://")+3;var d=a.origin.substring(c);d=d.split(":")[0];(c=b.domain)&&".force.com"===d.substr(-10)&&(c=c.split("/")[0]);a.origin!==window.esw.parentOrigin.substr(0,a.origin.length)?console.log("Message origin must match parent origin!"):d!==c&&-1===d.indexOf("."+c,d.length-c.length-1)?console.log("storageDomain ("+b.domain+
") must be a parent of message origin domain ("+d+")!"):(a=b.method.split(".")[0].toLowerCase(),-1===this.availableFeatures.indexOf(a)?(this.pendingMessages[a]||(this.pendingMessages[a]=[]),this.pendingMessages[a].push(b)):this.handleMessage(b))}}.bind(this),!1)};e.prototype.handleMessage=function(a){if(this.messageHandlers[a.method])this.messageHandlers[a.method](a.domain,a.data);else console.log("Unregistered method "+a.method+" received in frame.")};e.prototype.defineFeature=function(a,b){this.featureScripts[a]=
b};e.prototype.loadFeatureScript=function(a,b){var c=a.toLowerCase();if(-1<n.indexOf(c)){var d=document.createElement("script");d.type="text/javascript";d.src="frame/"+c+".esw"+(window.devMode?"":".min")+".js";d.onload=function(){this.featureScripts[a](this);b&&b();this.availableFeatures.push(c);this.processPendingMessages(c)}.bind(this);document.body.appendChild(d)}else throw Error('"'+a+'" is not a valid feature name.');};e.prototype.postMessage=function(a,b){parent.postMessage({method:a,data:b},
this.parentOrigin)};e.prototype.processPendingMessages=function(a){this.pendingMessages[a]&&(this.pendingMessages[a].forEach(function(b){this.handleMessage(b)}.bind(this)),this.pendingMessages[a]=void 0)};window.esw=new e})();
