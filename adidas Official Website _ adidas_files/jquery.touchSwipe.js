...
(function (factory) {
    if (typeof app.define === 'function' && app.define.amd && app.define.amd.jQuery) {
        // AMD. Register as anonymous module.
        app.define('vendor/jquery.touchSwipe', ['jquery'], factory);
    } else {
        // Browser globals.
        factory(jQuery);
    }
	...
	* @property {function} [longTap=null] A handler triggered when a user long taps on the item. The delay between start and end can be set with the longTapThreshold property. See {@link $.fn.touchSwipe.defaults#doubleTapThreshold}
	...
	*/
	function init(options) {
		...
		if(options && (options.click!==undefined && options.tap===undefined)) {
