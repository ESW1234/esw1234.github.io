// originally from https://gist.github.com/iainreid820/5c1cc527fe6b5b7dba41fec7fe54bf6e

//export interface IPackageJSON extends Object {
export interface IPackage extends Object {

  readonly name: string;

  readonly displayName?: string; // jb added
  ...
  readonly customSettings?: Object; // jb added
}
