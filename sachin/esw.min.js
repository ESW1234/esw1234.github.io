...
embedded_svc.utils?embedded_svc.utils.addEventHandler(a,b):(this.storedEventHandlers[a]||(this.storedEventHandlers[a]=[]),this.storedEventHandlers[a].push(b))};d.prototype.getHostnameFromUrl=function(a){window.URL&&"function"===typeof window.URL?a=(new URL(a)).hostname:(a=-1<a.indexOf("//")?a.split("/")[2]:a.split("/")[0],a=a.split(":")[0],a=a.split("?")[0]);return a};d.prototype.isProtocolHttpOrHttps=function(a){a=window.URL&&"function"===typeof window.URL?(new URL(a)).protocol:a.split("/")[0];String.prototype.startsWith||
Object.defineProperty(String.prototype,"startsWith",{value:function(b,c){c=0<c?c|0:0;return this.substring(c,c+b.length)===b}});return a.startsWith("http:")||a.startsWith("https:")};d.prototype.setupMessageListener=function(){window.addEventListener("message",function(a){var b=a.data,c=a.origin.split(":")[1].replace("//",""),e=embedded_svc.isProtocolHttpOrHttps(a.origin),f=embedded_svc.getHostnameFromUrl(this.settings.iframeURL);b&&b.method&&embedded_svc.isMessageFromSalesforceDomain(c)&&e&&c===f&&
("session.onLoad"===b.method&&-1===this.settings.iframeURL.indexOf(c)&&(c=this.settings.iframeURL.split("/")[2],a=a.origin.split("/")[2],this.settings.iframeURL=this.settings.iframeURL.replace(c,a)),a=b.method.split(".")[0].toLowerCase(),-1===this.availableFeatures.indexOf(a)?(this.pendingMessages[a]||(this.pendingMessages[a]=[]),this.pendingMessages[a].push({direction:"incoming",payload:b})):this.handleMessage(b))}.bind(this),!1)};d.prototype.handleMessage=function(a){var b=this.messageHandlers[a.method];
