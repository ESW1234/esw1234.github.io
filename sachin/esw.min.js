...
Object.defineProperty(String.prototype,"startsWith",{value:function(b,c){c=0<c?c|0:0;return this.substring(c,c+b.length)===b},configurable:!0});return"http:"===a.substring(0,5)||"https:"===a.substring(0,6)};d.prototype.setupMessageListener=function(){window.addEventListener("message",function(a){var b=a.data,c=a.origin.split(":")[1].replace("//",""),e=embedded_svc.isProtocolHttpOrHttps(a.origin),f=embedded_svc.getHostnameFromUrl(this.settings.iframeURL);b&&b.method&&embedded_svc.isMessageFromSalesforceDomain(c)&&
